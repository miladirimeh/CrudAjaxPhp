...
<html>
<head>
    <title> CRUD Operation using PHP AJAX/jQuery</title>
...
<div class="container">
    ...
    <div class="well" style="margin-left:auto; margin-right:auto; padding:auto; width:70%;">
        <span style="font-size:25px; color:blue"><strong>PHP CRUD Operation using AJAX/jQuery</br>(by Rimeh Miladi)</strong></span>	
